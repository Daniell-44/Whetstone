  ...
  return (
    <div ref={containerRef} class="relative w-full sm:w-auto">
      <button
        ...
        disabled={disabled}
        class="w-full sm:w-auto px-4 py-2.5 rounded-lg text-sm font-medium text-gray-500 border border-gray-200 hover:bg-gray-50 hover:text-gray-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-1.5"
      >
        Try an example
