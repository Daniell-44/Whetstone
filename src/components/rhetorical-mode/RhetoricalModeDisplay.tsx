    ...
    <div class="space-y-4">
      <div class="rounded-lg border border-gray-200 bg-white p-4">
        <div class="flex items-center justify-between mb-3">
          <p class="text-xs font-semibold uppercase tracking-widest text-gray-500">What it leans on</p>
      ...
      {result.moves.length > 0 && (
        <div class="space-y-2">
          <p class="text-xs font-semibold uppercase tracking-widest text-gray-500">Specific moves</p>
