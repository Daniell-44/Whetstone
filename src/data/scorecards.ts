...
//
// `spectrumAxis` + per-position `leaning` drive the position spectrum. On real
// scorecards these are generated by Stage 2 of the synthesis engine; the values
// below were seeded by hand for the placeholder set and can be adjusted.
...
export const scorecards: Scorecard[] = [
  {
    ...
    category: 'education',
    spectrumAxis: { left: 'structural ban', right: 'taught autonomy' },
...

  {
    ...
    category: 'technology',
    spectrumAxis: { left: 'displacement', right: 'augmentation' },
...

  {
    ...
    spectrumAxis: { left: 'individual action', right: 'systemic change' },
...

  {
    ...
    category: 'law',
    spectrumAxis: { left: 'public utility', right: 'private editorial' },
...

  {
    ...
    category: 'science',
    spectrumAxis: { left: 'permit', right: 'prohibit' },
...

  {
    ...
    category: 'philosophy',
    spectrumAxis: { left: 'coherent framework', right: 'structural flaws' },
