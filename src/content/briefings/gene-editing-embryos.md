...
::evidence
naturemedicine | CRISPR-Cas9 in Human Embryos: 2023 Update | Nature Medicine, 2023 | https://www.nature.com/nm/ | 2023 technical update on CRISPR-Cas9 performance in human embryos; supplies the efficacy evidence (correction rates) the permit camp cites. Empirical; takes no policy stance here.
...
::position colour=0 source=internationalc label="Yes: it would prevent suffering"
...
::audit name="Unstated Risk-Symmetry Assumption" kind=structural
...
::position colour=1 source=naturebiotechn label="No: it crosses a line"
...
::audit name="Argument from Ignorance" kind=structural
...
::position colour=2 source=whoexpert label="Permit only for severe single-gene disorders"
...
::audit name="Unstated Institutional-Capacity Assumption" kind=structural
