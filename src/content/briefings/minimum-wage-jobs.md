...
::position colour=0 source=jardim label="Price floors cut jobs" quote="the second wage increase to $13 reduced hours worked in low-wage jobs by 6-7 percent"
The disemployment case now leans on its cleanest natural experiment. Studying Seattle's ordinance, Jardim and colleagues found that "the second wage increase to $13 reduced hours worked in low-wage jobs by 6-7 percent". That is the textbook price-floor effect, turning up in the hours data. Read as a general law it says: raise the wage floor and the market buys less low-wage labour.
::audit name="Hasty Generalisation" kind=structural
It is one city, at a wage ($13) near the top of the range anyone had studied; treating Seattle's result as what every labour market does assumes they all clear the same way. That is the very point in dispute.

Which is where the evidence comes in, and the other camp denies exactly that.

::position colour=1 source=cengiz label="Monopsony absorbs it" quote="the overall number of low-wage jobs remained essentially unchanged over five years following the increase"
...
It slides from "increases within the studied range left employment unchanged" to "no increase could cost jobs". Those are two different claims; the measured changes never approached the levels the disemployment case worries about.

::shared
Both sides, though, stand on the same floor. Each treats today's labour market as the fixed backdrop; neither asks what a market with sectoral bargaining, or a higher wage held for a decade, would do. That is the question that would actually settle it.
