...
import { handleHumilityRequest } from '../../../functions/_lib/epistemic-humility/handler';
...
export const POST: APIRoute = async ({ request }) => {
  ...
  return handleHumilityRequest(request, {
    rateLimitKv:       env.RATE_LIMIT,
    geminiApiKey:      env.GEMINI_API_KEY,
    humilityDailyCap:  parseInt(env.HUMILITY_DAILY_CAP ?? '50', 10),
    provider,
